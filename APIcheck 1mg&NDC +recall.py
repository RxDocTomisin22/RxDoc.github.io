...
def load_recalled_drugs(file_path):
    # Load recalled drugs from Excel
    try:
...
def main():
    ...
    # Display details from the 1mg API
    if response1:
    ...
    if response2.get('results'):
        ...
        print("No data found from NDC API.")
